...
def solutionPartOne(list):
    ...
    for i in range(0,len(list)):
        ...
        countLetter = 0
        information = list[i].split(' ')
        lowerBound = int(information[0].split('-')[0])
        upperBound = int(information[0].split('-')[1])
        letter = information[1][0]
        ...
        if countLetter >= lowerBound and countLetter <=upperBound:
            countValid +=1
...
def solutionPartTwo(list):
    ...
    for i in range(0,len(list)):
        ...
        information = list[i].split(' ')
        firstPosition = int(information[0].split('-')[0])
        secondPosition = int(information[0].split('-')[1])
        letter = information[1][0]
        password = information[2]

        if (password[firstPosition - 1] == letter or password[secondPosition - 1] == letter) and (password[firstPosition - 1] != password[secondPosition - 1]):
            countValid +=1
